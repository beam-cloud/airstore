...
var file_worker_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x8a, 0x04, 0x0a, 0x0d, 0x57, 0x6f, 0x72,
...
var file_worker_proto_depIdxs = []int32{
	...
	1,  // 8: worker.WorkerService.RegisterWorker:output_type -> worker.RegisterWorkerResponse
	3,  // 9: worker.WorkerService.Heartbeat:output_type -> worker.HeartbeatResponse
	5,  // 10: worker.WorkerService.UpdateStatus:output_type -> worker.UpdateStatusResponse
	7,  // 11: worker.WorkerService.Deregister:output_type -> worker.DeregisterResponse
	9,  // 12: worker.WorkerService.GetWorker:output_type -> worker.GetWorkerResponse
	11, // 13: worker.WorkerService.ListWorkers:output_type -> worker.ListWorkersResponse
	13, // 14: worker.WorkerService.SetTaskResult:output_type -> worker.SetTaskResultResponse
