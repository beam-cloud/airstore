...
// / Parse version of ClassifyRowMatch (Takes in string and returns types.RowMatchResult)
func (*parse) ClassifyRowMatch(text string, opts ...CallOptionFunc) (types.RowMatchResult, error) {
	...
	casted := (result).(types.RowMatchResult)
