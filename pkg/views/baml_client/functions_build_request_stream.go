...
// Build streaming HTTP request for ClassifyRowMatch (returns baml.HTTPRequest)
func (*build_request_stream) ClassifyRowMatch(columns []types.ViewColumn, incoming_cells string, candidate_rows string, opts ...CallOptionFunc) (baml.HTTPRequest, error) {
	...
	args := baml.BamlFunctionArguments{
		Kwargs: map[string]any{"columns": columns, "incoming_cells": incoming_cells, "candidate_rows": candidate_rows, "stream": true},
		Env:    getEnvVars(callOpts.env),
	}
...
// Build streaming HTTP request for GenerateStatusOptions (returns baml.HTTPRequest)
func (*build_request_stream) GenerateStatusOptions(table_title string, column_key string, column_label string, sibling_columns string, opts ...CallOptionFunc) (baml.HTTPRequest, error) {
	...
	args := baml.BamlFunctionArguments{
		Kwargs: map[string]any{"table_title": table_title, "column_key": column_key, "column_label": column_label, "sibling_columns": sibling_columns, "stream": true},
		Env:    getEnvVars(callOpts.env),
	}
