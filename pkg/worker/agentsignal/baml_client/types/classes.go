...
func (c *ExtractedOutput) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "kind":
			c.Kind = baml.Decode(valueHolder).Interface().(OutputKind)
...
type FanOutSignal struct {
	Intent FanOutIntent  `json:"intent"`
...
func (c *FanOutSignal) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "intent":
			c.Intent = baml.Decode(valueHolder).Interface().(FanOutIntent)
...
type FollowUpSignal struct {
	Intent                FollowUpIntent       `json:"intent"`
...
func (c *FollowUpSignal) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "intent":
			c.Intent = baml.Decode(valueHolder).Interface().(FollowUpIntent)

		case "delay_minutes":
			c.Delay_minutes = baml.Decode(valueHolder).Int()
...
func (c *SourceWatchRequest) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "include_attachments":
			c.Include_attachments = baml.Decode(valueHolder).Bool()

		case "include_inline":
			c.Include_inline = baml.Decode(valueHolder).Bool()

		case "include_message_body":
			c.Include_message_body = baml.Decode(valueHolder).Bool()
...
func (c *SubtaskSpec) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "wake_delay_minutes":
			c.Wake_delay_minutes = baml.Decode(valueHolder).Int()
...
type TurnClassification struct {
	...
	Input_kind *InputKind  `json:"input_kind"`
}
...
func (c *TurnClassification) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "input_kind":
			c.Input_kind = baml.Decode(valueHolder).Interface().(*InputKind)
